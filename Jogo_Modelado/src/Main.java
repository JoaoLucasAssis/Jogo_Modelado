    ...
    public static int combate(Personagem p1, Arma_IF a1, Personagem p2, Arma_IF a2) {
        ...
        do {
            ...
            if(i == 1) { 
                switch (opcaoCombate) {
                    case 0 -> {
                        MsgDeInformacao("Vida do personagem 2: "+p1.vidas, coracao);
                        if(p1.vidas > 40 && p1.vidas <= 100) 
                            p1.vidas *= 1.10;
                        else if(p1.vidas > 20 && p1.vidas <= 40 )
                            p1.vidas *= 1.50;
                        else
                            p1.vidas *= 2;
                        MsgDeInformacao("Vida atual do personagem 2: "+p1.vidas, coracao);
                }
                    case 1 -> {
                        atacar(p1);
                        p2.vidas -= a1.ataque;
                ...
                switch (opcaoCombate) {
                    case 0 -> {
                        MsgDeInformacao("Vida atual do personagem 2: "+p2.vidas, coracao);
                        if(p2.vidas > 40 && p2.vidas <= 100) 
                            p2.vidas *= 1.10;
                        else if(p2.vidas > 20 && p2.vidas <= 40 )
                            p2.vidas *= 1.50;
                        else
                            p2.vidas *= 2;
                        MsgDeInformacao("Vida do personagem 2: "+p2.vidas, coracao);
